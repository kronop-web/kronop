...
const earningsApi = {
  getEarningsData: async () => ({ data: { totalRevenue: 1250.50, currentBalance: 850.25, pendingBalance: 200.25, totalEarned: 2500.75, thisMonth: 350.50, lastMonth: 400.25, currency: 'USD' } }),
  getUserBalance: async () => ({ data: { availableBalance: 650.00 } }),
  getUserPoints: async () => ({ data: { points: 300 } })
};

// Simple theme colors to replace complex theme system
const theme = {
  colors: {
    text: {
      primary: '#FFFFFF',
