...
const BUNNY_CONFIG: BunnyConfigType = {
  ...
  ACCESS_KEY: process.env.EXPO_PUBLIC_BUNNY_API_KEY_VIDEO || process.env.BUNNY_LIBRARY_ACCESS_KEY_VIDEO || process.env.EXPO_PUBLIC_BUNNY_API_KEY || process.env.BUNNY_API_KEY || '',
